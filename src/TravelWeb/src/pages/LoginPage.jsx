      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-slate-900 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white w-full">
          <div className="flex items-center gap-3">
            {/* Isotipo "MT": misma decision pendiente que components/Layout.jsx (guia de
                rollout 2026-08-16) — se mantiene en indigo, sin tocar, hasta que Gaston
                confirme si pasa a azul boleto o queda como acento de marca aparte. */}
            <div className="flex h-10 w-10 items-center justify-center rounded-[10px] bg-indigo-500/20 text-indigo-400 backdrop-blur-sm border border-indigo-500/30">
          ...
          <div className="space-y-6 max-w-lg">
            <h1 className="text-4xl font-bold leading-tight">
              ...
              <span className="text-blue-400">con excelencia.</span>
            </h1>
      ...
      <div className="flex w-full items-center justify-center p-8 lg:w-1/2 bg-white dark:bg-slate-950">
        <div className="w-full max-w-sm space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <div className="text-center lg:text-left">
            <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-[10px] bg-indigo-600/10 text-indigo-600 lg:hidden dark:bg-indigo-500/10 dark:text-indigo-400">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  type="email"
                  required
                  className="w-full rounded-[10px] border border-slate-200 bg-white px-10 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:border-primary focus:outline-none focus:ring-1 focus:ring-ring dark:border-slate-800 dark:bg-slate-900 dark:text-white"
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                className="h-4 w-4 rounded border-slate-300 text-primary focus:ring-ring dark:border-slate-700 dark:bg-slate-900"
              />
              <label
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="group w-full gap-2 py-2.5 shadow-md"
            >
              {isLoading ? (
