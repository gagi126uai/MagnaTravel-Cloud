    ...
    return (
        <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                ...
                <JourneyCard label="Cotizacion" value={detailJourney?.quotes?.[0]?.quoteNumber || "Sin cotizacion"} meta={detailJourney?.quotes?.[0]?.status || (detailJourney?.latestQuotePublicId ? "Disponible" : "Discontinuada - usar Presupuesto")} actionLabel={detailJourney?.latestQuotePublicId ? "Abrir" : "N/A"} disabled={!detailJourney?.latestQuotePublicId} onAction={() => { if (detailJourney?.latestQuotePublicId) navigate("/quotes", { state: { openQuoteId: detailJourney.latestQuotePublicId } }); }} />
