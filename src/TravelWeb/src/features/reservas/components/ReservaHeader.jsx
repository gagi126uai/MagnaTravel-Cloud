        ...
        <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-3">
                ...
                <div className="flex gap-2 ml-2 pl-4 border-l border-slate-200 dark:border-slate-800">
                    ...
                    <button onClick={onArchive} className="p-2.5 bg-slate-100 text-slate-600 hover:bg-slate-200 dark:bg-slate-800 dark:text-slate-400 dark:hover:bg-slate-700 rounded-xl transition-colors" title="Archivar">
