 ...
 *
 * Modos de uso:
 *   - Mono-moneda: sin selectores de moneda ni "Imputar a"; idéntico al modal viejo.
 *   - Multimoneda: muestra "Moneda del cobro" e "Imputar a" (decisión B, 2026-06-11).
...
export function RegistrarCobroInline({
    reservaId,
    reserva,       // Se usa para saber si es multimoneda y los saldos por moneda
    ...
    const [monedaCobro, setMonedaCobro] = useState("ARS");
    const [saldoImputado, setSaldoImputado] = useState("ARS");  // moneda del saldo al que se imputa
    ...
    useEffect(() => {
        if (paymentToEdit) {
            ...
            setMonedaCobro(paymentToEdit.currency || "ARS");
            setSaldoImputado(paymentToEdit.imputedCurrency || paymentToEdit.currency || "ARS");
            ...
            // Nuevo cobro: defaults limpios
            setMonto("");
            setMonedaCobro("ARS");
            setSaldoImputado("ARS");
        ...
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    ...
                    {/* Moneda del cobro: visible SOLO en multimoneda y cuando NO se edita un cruzado */}
                    {esMultimoneda && (
                        <div className="space-y-1">
                    ...
                    {/* Imputar a: visible SOLO en multimoneda y cuando NO se edita un cruzado */}
                    {esMultimoneda && (
                        <div className="space-y-1">
                    ...
                    >
                        ...
                        {montoEquivalente != null && (
                            <p className="text-xs font-medium text-indigo-700 dark:text-indigo-300 mt-1">
                                → Se cancelan{" "}
                                <strong>
                                    <CurrencyBadge currency={saldoImputado} />
                                    {" "}{formatCurrency(montoEquivalente, saldoImputado)}
                                </strong>
