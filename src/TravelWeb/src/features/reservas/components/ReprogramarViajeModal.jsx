...
export function ReprogramarViajeModal({ isOpen, reserva, onClose, onReprogramada }) {
    ...
    return (
        ...
        >
            <div
                className="w-full max-w-md rounded-[14px] border bg-white shadow-2xl dark:bg-slate-900 dark:border-slate-800"
            ...
            >
                ...
                <div className="p-6 space-y-5">
                    ...
                    {sinFechaSalida && (
                        <div
                            className="rounded-[10px] border border-amber-200 bg-amber-50 p-3 text-sm text-amber-800 dark:border-amber-800 dark:bg-amber-950/30 dark:text-amber-200"
                            role="note"
                        >
                    ...
                    <div className="rounded-[10px] border border-slate-200 bg-slate-50 px-4 py-3 dark:border-slate-800 dark:bg-slate-800/50">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            disabled={enviando}
                            className="w-full rounded-[10px] border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 disabled:opacity-50 dark:border-slate-700 dark:bg-slate-800 dark:text-white"
                    ...
                    {nuevaSalida && deltaDias !== null && (
                        <div
                            className="rounded-[10px] border border-blue-200 bg-blue-50 px-4 py-3 text-sm dark:border-blue-800 dark:bg-blue-950/30"
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2 font-semibold text-blue-800 dark:text-blue-200 mb-2">
                                ...
                                <span className="ml-auto text-xs font-bold text-blue-600 dark:text-blue-300">
                    ...
                    <div
                        className="rounded-[10px] border border-slate-200 bg-slate-50 px-3 py-2.5 text-xs text-slate-600 dark:border-slate-700 dark:bg-slate-800/50 dark:text-slate-400"
                        role="note"
                    >
