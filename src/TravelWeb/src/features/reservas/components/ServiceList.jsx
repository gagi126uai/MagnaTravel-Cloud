            ...
            <div className="w-full max-w-sm rounded-[14px] border bg-white shadow-2xl dark:bg-slate-900 dark:border-slate-800">
                            ...
                            {saleInvoices.length > 1 && (
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full rounded-[10px] border border-slate-200 bg-white px-3 py-2 text-sm dark:border-slate-700 dark:bg-slate-800 dark:text-white"
                ...
                <div className="flex justify-end gap-3 border-t border-slate-100 px-6 py-4 dark:border-slate-800">
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 rounded-[10px] px-4 py-2 text-sm font-bold text-white transition-colors disabled:opacity-50 ${
                            estaConfirmado
        ...
        >
            <div className="w-full max-w-md rounded-[14px] border bg-white shadow-2xl dark:bg-slate-900 dark:border-slate-800">
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="rounded-[10px] border border-rose-100 bg-rose-50 px-4 py-3 text-sm text-rose-800 dark:border-rose-900/40 dark:bg-rose-950/20 dark:text-rose-200">
                        {mensaje}
                    </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row justify-end gap-3 border-t border-slate-100 px-6 py-4 dark:border-slate-800">
                    <button
                        ...
                        type="button"
                        onClick={onClose}
                        className="rounded-[10px] px-4 py-2 text-sm font-bold text-slate-600 hover:bg-slate-100 transition-colors dark:text-slate-300 dark:hover:bg-slate-800"
                    >
                        Entendido
                    </button>
...
function ResumenServiciosResueltos({ services, reservaStatus }) {
    ...
    return (
        <div
            className="mb-4 flex items-center gap-3 rounded-[10px] border border-cyan-200 bg-cyan-50 px-4 py-2.5 text-sm dark:border-cyan-900/40 dark:bg-cyan-950/20"
...
function ServiceSupplierChip({ supplierName, supplierPublicId, puedeVerProveedores, testId }) {
    ...
    if (puedeVerProveedores && supplierPublicId) {
        return (
            <Link
                ...
                className="mt-0.5 inline-flex w-fit items-center gap-1 text-[11px] text-primary hover:underline"
                data-testid={testId}
            >
    ...
    return (
        <div className="mt-0.5 text-[11px] text-slate-400 dark:text-slate-500" data-testid={testId}>
            Operador: {supplierName}
        </div>
    );
}
...
function BannerGrupoPendienteContenido({ grupo, esPrimero }) {
    return (
        <div
            className="flex items-start gap-2 rounded-[10px] border border-amber-200 bg-amber-50 px-4 py-2.5 text-sm text-amber-800 dark:border-amber-900/40 dark:bg-amber-950/20 dark:text-amber-300"
            ...
            <div className="relative">
                ...
                {mostrarMas && (
                    <div
                        ...
                        className="absolute right-0 top-full z-20 mt-1 w-40 rounded-[14px] border border-slate-200 bg-white p-1.5 shadow-lg dark:border-slate-700 dark:bg-slate-900"
                    >
                        {accionesOriginales}
                    </div>
                )}
                            ...
                            <div key={`${slot.slot}-${i}`}>
                                ...
                                {!esteSlotAbierto && (
                                    <button
                                        ...
                                        className="inline-flex items-center gap-1.5 rounded-[10px] border border-amber-300 bg-amber-100 px-3 py-1.5 text-xs font-bold text-amber-700 hover:bg-amber-200 dark:border-amber-700 dark:bg-amber-900/30 dark:text-amber-300"
                                    >
    ...
    return (
        <div>
                    ...
                    {canCancelServices && puedeCancelarServicios && serviciosCancelables.length >= 2 && !showCancelarVarios && (
                        candadoDeEdicionActivo ? (
                            <button
                                ...
                                className="flex items-center justify-center gap-2 border border-slate-200 bg-slate-100 text-slate-500 px-4 py-2 rounded-[10px] hover:bg-slate-200 transition-colors text-sm font-semibold dark:border-slate-700 dark:bg-slate-800 dark:text-slate-400 dark:hover:bg-slate-700"
                            >
                            ...
                            <button
                                ...
                                data-testid="btn-cancelar-varios"
                                className="flex items-center justify-center gap-2 border border-amber-300 bg-amber-50 text-amber-700 px-4 py-2 rounded-[10px] hover:bg-amber-100 transition-colors text-sm font-semibold dark:border-amber-700 dark:bg-amber-950/30 dark:text-amber-300 dark:hover:bg-amber-900/40"
                            >
                    ...
                    {puedeEditarServicios && (
                        candadoDeEdicionActivo ? (
                            <button
                                ...
                                className="flex items-center justify-center gap-2 bg-slate-100 text-slate-500 px-4 py-2 rounded-[10px] hover:bg-slate-200 transition-colors shadow-sm text-sm dark:bg-slate-800 dark:text-slate-400 dark:hover:bg-slate-700"
                            >
                            ...
                            <button
                                ...
                                className="flex items-center justify-center gap-2 bg-primary text-primary-foreground px-4 py-2 rounded-[10px] hover:bg-primary/90 transition-colors shadow-sm text-sm"
                            >
            ...
            {collectionErrorMessages.length > 0 ? (
                <div className="mb-4 rounded-[10px] border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800 dark:border-amber-900/40 dark:bg-amber-950/20 dark:text-amber-300">
                    <div className="flex items-start gap-3">
                        <AlertTriangle className="mt-0.5 h-4 w-4 flex-shrink-0" />
                ...
                <>
                                        ...
                                        <tr className="group border-b border-slate-50 dark:border-slate-800/50 hover:bg-slate-50/50 dark:hover:bg-slate-800/20 transition-colors">
                                            <td className="py-3 px-2.5 align-middle whitespace-nowrap">
                                                <div className="flex items-center">
                                                    ...
                                                    {isGeneric && (
                                                        <span className="ml-2 text-[11px] font-bold uppercase tracking-wider rounded-full bg-slate-100 dark:bg-slate-800 text-slate-500 px-2 py-0.5">
                                                            Generico
                                                        </span>
                                                    )}
                                                </div>
                                            ...
                                            <td className="py-3 px-2.5 align-middle">
                                                ...
                                                {esServicioAnulado(svc) &&
                                                    ...
                                                    <div className="mt-0.5 text-[11px] text-slate-400 dark:text-slate-500 flex items-center gap-1">
                                                        <span>Anulado</span>
                                                ...
                                                <div className="flex flex-wrap gap-2 mt-1">
                                                    ...
                                                    {svc.pnr && (
                                                        <span className="text-[11px] bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 px-1.5 py-0.5 rounded font-mono font-bold">PNR: {svc.pnr}</span>
                                                    )}
                                                    {svc.confirmationNumber && (
                                                        <span className="text-[11px] bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-400 px-1.5 py-0.5 rounded flex items-center gap-1 font-medium">
                                                            <ShieldCheck className="w-3 h-3" /> {svc.confirmationNumber}
                                                        </span>
                                                    )}
                                                    {svc.recordKind === SERVICE_RECORD_KIND.FLIGHT && svc.origin && (
                                                        <span className="text-[11px] text-slate-400">{svc.origin} ➔ {svc.destination}</span>
                                                    )}
                                                    {svc.recordKind === SERVICE_RECORD_KIND.TRANSFER && svc.pickupLocation && (
                                                        <span className="text-[11px] text-slate-400">{svc.pickupLocation} ➔ {svc.dropoffLocation}</span>
                                                    )}
                                                    {/* Datos clave de la asistencia: poliza, plan y zona */}
                                                    {svc.recordKind === SERVICE_RECORD_KIND.ASSISTANCE && svc.policyNumber && (
                                                        <span className="text-[11px] bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 px-1.5 py-0.5 rounded font-mono font-bold">Poliza: {svc.policyNumber}</span>
                                                    )}
                                                    {svc.recordKind === SERVICE_RECORD_KIND.ASSISTANCE && svc.planType && (
                                                        <span className="text-[11px] bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 px-1.5 py-0.5 rounded">{svc.planType}</span>
                                                    )}
                                                    {svc.recordKind === SERVICE_RECORD_KIND.ASSISTANCE && svc.coverageZone && (
                                                        <span className="text-[11px] text-slate-400">{svc.coverageZone}</span>
                                                    )}
                                                </div>
                                            </td>
                                                ...
                                                {svc.recordKind === SERVICE_RECORD_KIND.HOTEL || svc.recordKind === SERVICE_RECORD_KIND.PACKAGE ? (
                                                    <div className="flex flex-col">
                                                        ...
                                                        {formatDate(svc.endDate || svc.checkOut) !== '-' && (
                                                            <span className="text-[11px] opacity-60">al {formatDate(svc.endDate || svc.checkOut)}</span>
                                                        )}
                                                    </div>
                                                    ...
                                                    <div className="flex flex-col">
                                                        ...
                                                        {formatDate(svc.validTo) !== '-' && (
                                                            <span className="text-[11px] opacity-60">al {formatDate(svc.validTo)}</span>
                                                        )}
                                                    </div>
                                                ) : (
                                                    formatDate(svc.date)
                                                ...
                                                <div className="flex flex-col items-end gap-1.5">
                                                    ...
                                                    {!esServicioAnulado(svc) && (() => {
                                                        ...
                                                        {bloqueoAnular.bloqueado && (
                                                            <span
                                                                className="inline-flex max-w-[220px] items-center justify-end gap-1 text-right text-[11px] font-semibold text-amber-700 dark:text-amber-400"
                    ...
                    <div className="md:hidden space-y-4">
                        {services.map((svc) => {
                            ...
                            return (
                                <div className="bg-white dark:bg-slate-900 p-4 rounded-[14px] border border-slate-100 dark:border-slate-800 shadow-sm">
                                    <div className="flex justify-between mb-2">
                                        <div className="flex items-center gap-2">
                                            ...
                                            {isGeneric && (
                                                <span className="text-[11px] font-bold uppercase rounded-full bg-slate-100 dark:bg-slate-800 text-slate-500 px-2 py-0.5">
                                                    Generico
                                                </span>
                                            )}
                                        </div>
                                    ...
                                    {esServicioAnulado(svc) &&
                                        (svc.cancelledAt || svc.cancelledByUserName) && (
                                        <div className="mb-1 text-[11px] text-slate-400 dark:text-slate-500 flex items-center gap-1 flex-wrap">
                                            <span>Anulado</span>
                                            {svc.cancelledByUserName && (
                                                <span>por <span className="font-semibold">{svc.cancelledByUserName}</span></span>
                                            )}
                                        ...
                                        <div className="flex flex-col items-end gap-2">
                                                    ...
                                                    <>
                                                        {svc.recordKind === SERVICE_RECORD_KIND.FLIGHT && (
                                                            pasajerosListos ? (
                                                                ...
                                                                <span
                                                                    className="text-[11px] font-semibold text-amber-600 dark:text-amber-400 text-right"
                                            ...
                                            {!esServicioAnulado(svc) && (puedeEditarServicios || puedeCancelarServicios) && (() => {
                                                ...
                                                const bloqueEdicionYBorradoMobile = (
                                                        ...
                                                        {puedeEditarServicios && (
                                                            candadoDeEdicionActivo ? (
                                                                <button
                                                                    ...
                                                                    aria-label="Editar servicio — bloqueado, pedí autorización"
                                                                    className="inline-flex items-center gap-1 p-2 text-slate-400 rounded-[10px] bg-slate-100 dark:bg-slate-800 dark:text-slate-500 text-xs font-semibold"
                                                                >
                                                                ...
                                                                <button
                                                                    ...
                                                                    data-testid={`btn-edit-service-mobile-${getReservationServicePublicId(svc)}`}
                                                                    aria-label="Editar servicio"
                                                                    className="inline-flex items-center gap-1 p-2 text-slate-500 rounded-[10px] bg-slate-50 dark:bg-slate-800 text-xs font-semibold"
                                                                >
                                                        ...
                                                        {mostrarDestructivoMobile && (
                                                            candadoDeEdicionActivo ? (
                                                                ...
                                                                <button
                                                                    ...
                                                                    className="inline-flex items-center gap-1 p-2 text-slate-300 dark:text-slate-600 rounded-[10px] bg-slate-50 dark:bg-slate-800 text-xs font-semibold cursor-not-allowed"
                                                                >
                                                                ...
                                                                <button
                                                                    ...
                                                                    className="inline-flex items-center gap-1 p-2 text-red-500 rounded-[10px] bg-red-50 dark:bg-red-900/20 text-xs font-semibold"
                                                                >
                                                                    <Trash2 className="w-3.5 h-3.5" />
                                                                    {textoTachoMobile}
                                                                </button>
                                                    ...
                                                    {bloqueoAnularMobile.bloqueado && (
                                                        <span
                                                            className="inline-flex max-w-[200px] items-center justify-end gap-1 text-right text-[11px] font-semibold text-amber-700 dark:text-amber-400"
