        ...
        >
            ...
            <div className="mt-5 pt-4 border-t border-slate-100 dark:border-slate-800 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                ...
                <div className="flex flex-col items-end gap-2 w-full sm:w-auto">
                    ...
                    {errorValidacion && (
                        <div
                            className="flex flex-col gap-2 text-xs text-red-700 bg-red-50 border border-red-200 rounded-[10px] px-3 py-2 w-full sm:w-auto max-w-sm dark:text-red-300 dark:bg-red-950/30 dark:border-red-900"
                            role="alert"
