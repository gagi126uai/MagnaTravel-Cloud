...
export default function ReservasPage() {
  ...
  return (
    <div className="animate-in fade-in space-y-4 duration-500 md:space-y-6">
      ...
      <div className="rounded-[14px] border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900/50">
        <div className="space-y-4 p-4 md:p-5">
          ...
          <ListToolbar
            ...
            searchSlot={
              <div className="flex flex-col gap-1">
                <div className="relative">
                  ...
                  <input
                    className="w-full rounded-[10px] border border-slate-200 bg-slate-50 py-2 pl-9 pr-9 text-sm placeholder:text-slate-500/70 focus:outline-none focus:ring-1 focus:ring-primary dark:border-slate-700 dark:bg-slate-800/50 dark:text-white"
            ...
            actionSlot={
              ...
              >
                <div className="flex items-center gap-1 rounded-[10px] border border-slate-200 bg-slate-50 px-2 py-1 dark:border-slate-700 dark:bg-slate-800/50">
                  <span className="text-[11px] font-bold uppercase text-slate-500">Por</span>
                  <select
                ...
                <div className="flex flex-wrap items-center gap-1 rounded-[10px] border border-slate-200 bg-slate-50 p-1 dark:border-slate-700 dark:bg-slate-800/50">
                  <select
                  ...
                  {dateRange.preset === "month" && (
                    <div className="flex items-center gap-0.5 rounded-[10px] bg-white p-0.5 dark:bg-slate-900">
                      ...
                      <div className="flex items-center px-1">
                        <span className="w-[90px] text-center text-[11px] font-black text-slate-700 dark:text-slate-200">
                          {monthNameEtiqueta}
                        </span>
                      </div>
