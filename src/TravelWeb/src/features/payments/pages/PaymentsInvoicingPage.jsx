  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white">Facturacion</h2>
          <p className="text-sm text-slate-500 dark:text-slate-400">
            Estado fiscal AFIP: lo listo para emitir, lo bloqueado por deuda y lo ya documentado.
          </p>
        </div>
