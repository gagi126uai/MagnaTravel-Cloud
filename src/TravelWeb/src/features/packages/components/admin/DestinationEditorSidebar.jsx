      ...
      <section className="rounded-[10px] border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900/50">
        ...
        <div className="mt-3 space-y-4">
          <div>
            ...
            <StatusChip tone={publicationToneMap[publicationState.tone] || "neutro"} className="mt-2">
...
// El tono viejo (slate/emerald/amber/blue, calculado en publicationUtils.js) se traduce
// al tono equivalente del molde StatusChip (B.5).
