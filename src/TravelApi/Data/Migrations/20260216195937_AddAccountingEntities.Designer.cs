...
namespace TravelApi.Data.Migrations
{
    ...
    [Migration("20260216195937_AddAccountingEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelApi.Models.AfipSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TravelApi.Models.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TravelApi.Models.InvoiceItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TravelApi.Models.InvoiceTribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TravelApi.Models.Invoice", b =>
                {
                    b.HasOne("TravelApi.Models.Invoice", "OriginalInvoice")
            ...
            modelBuilder.Entity("TravelApi.Models.InvoiceItem", b =>
                {
                    b.HasOne("TravelApi.Models.Invoice", "Invoice")
                        .WithMany("Items")
