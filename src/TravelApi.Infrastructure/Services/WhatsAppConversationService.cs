...
public class WhatsAppConversationService : IWhatsAppConversationService
{
    ...
    public WhatsAppConversationService(AppDbContext db, IEntityReferenceResolver entityReferenceResolver)
    {
        _db = db;
    ...
    private static List<WhatsAppConversationMessageDto> BuildLeadMessages(Lead lead)
    {
                     ...
                     .OrderBy(item => item.CreatedAt))
        {
            ...
            messages.Add(new WhatsAppConversationMessageDto
            {
                ...
                SenderLabel = isAgent ? (activity.CreatedBy ?? "Agente") : lead.FullName,
