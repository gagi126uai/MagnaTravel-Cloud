...
public class TransferBooking : IHasPublicId
{
    ...
    /// <summary>
    /// Obra "PDF ronda 2" (2026-08-14, spec §6): plan de cuotas informativo del traslado, mismo criterio
    ...
    /// <summary>Monto de cada cuota del traslado. Ver <see cref="InstallmentsCount"/>.</summary>
