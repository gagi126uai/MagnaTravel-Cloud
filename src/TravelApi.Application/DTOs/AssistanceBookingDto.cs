...
public class AssistanceBookingDto
{
    ...
    /// <summary>
    /// Opciones A/B/C (decisión #1 firmada, 2026-08-11/12): grupo de alternativas al que pertenece esta
    /// asistencia. Null = no es una alternativa de nada. Ver TravelApi.Domain.Reservations.OptionGroupRules.
    /// </summary>
