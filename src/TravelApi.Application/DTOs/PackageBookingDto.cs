...
public class PackageBookingDto
{
    ...
    /// paquete. Null = no es una alternativa de nada. Ver TravelApi.Domain.Reservations.OptionGroupRules.
    /// </summary>
    public string? OptionGroup { get; set; }
    public string? OptionLabel { get; set; }

    // Obra "PDF ronda 2" (2026-08-14): plan de cuotas informativo. Ver PackageBooking.InstallmentsCount/InstallmentAmount.
